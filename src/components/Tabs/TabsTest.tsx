export function TabsTest() {
    ...
    return (
        <div className="p-4">
            <div className="p-4  min-h-[6rem] min-w-[18rem] max-w-4xl bg-cover bg-top border rounded-b-box rounded-tr-box flex items-center justify-center flex-wrap gap-2 overflow-x-hidden">
                <div className="tabs">
